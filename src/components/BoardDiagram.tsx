...
// A(3)/B(4)/C(5)/D(4)/E(3) тАФ matches resources/rags/Catan/board_topology.json's hex_neighbors
...
const S = 30 // hex "radius" (center to vertex), in SVG user units тАФ kept small/compact
